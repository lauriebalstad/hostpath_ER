...
# save things!
saveRDS(gsa_result, file = paste0("dat/gsa_result_", format(Sys.time(), "%m%d-%H%M"), ".Rdata"))
# saveRDS(gsa_result, file = paste0("dat/retest_gsa200_", format(Sys.time(), "%m%d"), ".Rdata"))
