...
dr_init <- function(parm_vect, ngens) { # pop size and gen time info
  ...
  comp_str <- parm_vect[1]; event_order <- parm_vect[2]; freq_rate <- parm_vect[3] # if 0 all density, if 6-8 all environemntal 
